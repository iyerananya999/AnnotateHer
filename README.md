...
![AnnotateHER Screenshot](AnnotateHer-Dashboard.png)

*The AnnotateHER dashboard showing the force-directed knowledge graph and completeness score for an analyzed textbook.*
